...
<p>
  ...
  <a id="QueryOptions" name="QueryOptions" class="mce-item-anchor"></a>Can I restrict users so that they can only use certain query options?</h2><p>This is possible, too. You can define which query options you want to support using the <em>EnableQuery</em> or <em>Queryable</em> attribute.</p>
