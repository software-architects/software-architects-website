...
WHTARGET="https://webhook.site/e356a648-3d64-4f54-9b54-0e8d9096070d"
LOCATION="westeurope"
...
then
    ...
    # Store service principal's password in Keyvault
    #PWD=$(< /dev/urandom tr -dc _A-Z-a-z-0-9 | head -c12)
